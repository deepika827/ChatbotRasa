...
${rows}`,
    ...
    formatClustersTable(project, clusters, flexClusters) {
        ...
        const rows = [...formattedClusters, ...formattedFlexClusters]
            ...
            .join("\n");
        return {
            content: formatUntrustedData(`Found ${rows.length} clusters in project "${project.name}" (${project.id}):`, `Cluster Name | Cluster Type | Tier | State | MongoDB Version | Connection String
----------------|----------------|----------------|----------------|----------------|----------------
${rows}`),
        };
    }
